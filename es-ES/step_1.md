...
Si necesitas imprimir este proyecto, por favor usa la [versión para imprimir](https://projects.raspberrypi.org/es-ES/projects/blockscad-pendant/print){:target="_blank"}.

Descarga el código del proyecto terminado en: [https://rpf.io/p/es-ES/blockscad-pendant](https://rpf.io/p/es-ES/blockscad-pendant).
